...
<body>
	...
	<%
		...
		String connectionUrl = "jdbc:oracle:thin:@revatureguru.cuduhhnjsz0h.us-east-1.rds.amazonaws.com:1521:ORCL";
	...
	%>
	<h2 align="center">
		<font><strong>Employee</strong></font>
	</h2>

	<style>
</style>
	.
	<table id="mytable" align="center" cellpadding="5"
		...
		%>
		<tr bgcolor="white">
			<td><%=resultSet.getString("Trainee_Id")%></td>
			<td><%=resultSet.getString("Trainee_Name")%></td>
			<td><%=resultSet.getString("Major")%></td>
		...
		<input type="text" id="myInput" onkeyup="myFunction()"
			placeholder="Search for genre.." title="Type in a name">
	<script>
